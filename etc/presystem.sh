...
#注意，这里会删除基础源
#fn_log "yum clean all && yum update -y " && cd /etc/yum.repos.d/ &&  rm -rf CentOS-* && cp -a $PWD/lib/repo.repo  /etc/yum.repos.d/repo.repo && cp -a $PWD/lib/CentOS-Base.repo  /etc/yum.repos.d/CentOS-Base.repo

#
cd /etc/yum.repos.d/ &&  rm -rf CentOS-* && cp -a $PWD/lib/repo.repo  /etc/yum.repos.d/repo.repo && cp -a $PWD/lib/CentOS-Base.repo  /etc/yum.repos.d/CentOS-Base.repo
