...
mysql -uroot -p${DATABASE_PASSWORD} -e "CREATE DATABASE nova;" &&  \
mysql -uroot -p${DATABASE_PASSWORD} -e "CREATE DATABASE nova_api;" && \
mysql -uroot -p${DATABASE_PASSWORD} -e "GRANT ALL PRIVILEGES ON nova.* TO 'nova'@'localhost' IDENTIFIED BY '${ALL_PASSWORD}';" && \
mysql -uroot -p${DATABASE_PASSWORD} -e "GRANT ALL PRIVILEGES ON nova.* TO 'nova'@'%' IDENTIFIED BY '${ALL_PASSWORD}';"  && \
mysql -uroot -p${DATABASE_PASSWORD} -e "GRANT ALL PRIVILEGES ON nova_api.* TO 'nova'@'localhost'   IDENTIFIED BY '${ALL_PASSWORD}';" && \
mysql -uroot -p${DATABASE_PASSWORD} -e "GRANT ALL PRIVILEGES ON nova_api.* TO 'nova'@'%'   IDENTIFIED BY '${ALL_PASSWORD}';" 
